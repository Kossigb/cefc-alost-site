...
const I18N = {
  nl: {
    ...
    "services.address.shuttle": "Gratis pendeldienst beschikbaar",
    "services.address.map": "Bekijk op de kaart →",
    ...
    "dons.card2.title": "Speciale Giften",
    "dons.card2.text": "Speciale giften zijn eenmalige offers voor bijzondere behoeften: bouwprojecten, zending, hulp aan gezinnen in nood, kerkelijke evenementen.",
    "dons.card3.title": "Solidariteit",
    "dons.card3.text": "Het solidariteitsfonds stelt de kerk in staat leden in nood, gezinnen in moeilijkheden en sociale acties van de gemeenschap te ondersteunen.",
    "dons.card3.ref": "Bankrekening — Solidariteit :",
  ...
  en: {
    ...
    "services.address.shuttle": "Free shuttle available",
    "services.address.map": "View on map →",
    ...
    "dons.card2.title": "Special Gifts",
    "dons.card2.text": "Special gifts are one-time offerings for particular needs: construction projects, missions, help for families in need, church events.",
    "dons.card3.title": "Solidarity",
    "dons.card3.text": "The solidarity fund enables the church to support members in need, families facing difficulties and the community's social outreach.",
    "dons.card3.ref": "Bank account — Solidarity:",
